...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/panamacanal

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/panamacanal: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/1128534263/Enviroment.o: /media/data/Documents/CTU/6/pgr/PanamaCanal/Enviroment.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1128534263/Enviroment.o /media/data/Documents/CTU/6/pgr/PanamaCanal/Enviroment.cpp
...
${OBJECTDIR}/_ext/1128534263/Light.o: /media/data/Documents/CTU/6/pgr/PanamaCanal/Light.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1128534263
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1128534263/Light.o /media/data/Documents/CTU/6/pgr/PanamaCanal/Light.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/panamacanal
